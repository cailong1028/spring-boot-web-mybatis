...
public class BeanClassLoader extends ClassLoader {
    ...
    private boolean compile(String javaFile) throws IOException {
        ...
        Process p = Runtime.getRuntime().exec(
                "javac -classpath " + BeanClassLoader.class.getResource("/").getPath()
...
//		}
        ...
        // 构建指向源文件和类文件的对象。
        String javaFilename = BeanClassLoader.class.getResource("/").getFile() + "reload/"
                + fileStub + ".java";
        //System.out.println(javaFilename);
        String classFilename = BeanClassLoader.class.getResource("/").getFile() + "reload/"
                + fileStub + ".class";
